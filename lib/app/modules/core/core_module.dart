...
import 'package:cuidapet_mobile/app/core/local_storage/shared_preferences/flutter_shared_preferences_local_storage_impl.dart';
...
class CoreModule extends Module {
  ...
  List<Bind> binds = [
    ...
    Bind.lazySingleton<LocalStorage>(
        (i) => FlutterSharedPreferencesLocalStorageImpl(),
        export: true),
