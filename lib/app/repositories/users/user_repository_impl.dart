...
class UserRepositoryImpl implements UserRepository {
  ...
  Future<String> login(String email, String password) async {
    try {
      ...
      throw Failure(
          message: 'Erro ao realizar login, tenta novamente mais tarde');
    }
  }
  ...
  Future<String> loginSocial(SocialNetworkModel model) async {
    try {
      ...
      _log.error('Erro ao registra login', e, s);
      throw Failure(
          message: 'Erro ao registra login, tente novamente mais tarde');
    }
  }
}
